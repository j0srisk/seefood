const StatusBar = ({ children, status, backgroundColor }) => {
	return (
		<div className="z-10 flex h-20 w-full justify-center border-b-2 border-b-white ">
			...
			<p
				className={`z-20 flex h-full w-full items-center justify-center p-1 text-center font-inter text-4xl font-extrabold text-custom-yellow ${backgroundColor} lg:rounded-t-3xl`}
			>
				{status}
			</p>
		</div>
